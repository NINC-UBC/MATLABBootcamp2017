...
% possible sample that could have come from that same population.  The only
...
%iteration of the loop.  i can be used in the commands and gets a new value
...
%If you are interested in the permutation test try working through the full 
%resampling tutorial in the resampling folder.  Or if you would prefer 
%image processing try the VSD_example folder.